...
private static final String INSERT_EQUIPMENT = "insert into equipment VALUES(?,?,?,?,?)";
	...
	public EquipmentVO getEquipmentByRoomid(String roomId) {
		...
		return jdbcTemplate.queryForObject(GET_EQUIPMENT_BY_ROOMID, new EquipmentRowMapper());
	}
	
	public void insertEquipment(EquipmentVO vo) {
		Object[] args = {vo.getEquipment_id(),vo.getRoom_id(),
				vo.getEquipment_name(),vo.getEquipment_count(),
